...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "SkillArion Development" },
      ...
      { name: "twitter:title", content: "SkillArion Development — Bridging Academia & Industry" },
      { name: "twitter:description", content: "Hands-on technical workshops, internships, scholarships and placement programs for engineering and polytechnic students." },
    ],
    links: [
      { rel: "icon", href: "/skillarion-logo.png", type: "image/png" },
      { rel: "apple-touch-icon", href: "/skillarion-logo.png" },
